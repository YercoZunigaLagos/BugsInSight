                            ...
                            <div class="card text-white bg-primary">
                                ...
                                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="card-chart1" height="87"
                                        style="display: block; height: 70px; width: 302px;" width="377"></canvas>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card text-white bg-info">
                                ...
                                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="card-chart2" height="87"
                                        width="377" style="display: block; height: 70px; width: 302px;"></canvas>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card text-white bg-warning">
                                ...
                                <div class="c-chart-wrapper mt-3" style="height:70px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="card-chart3" height="87"
                                        width="417" style="display: block; height: 70px; width: 334px;"></canvas>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card text-white bg-danger">
                                ...
                                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="card-chart4" height="87"
                                        width="377" style="display: block; height: 70px; width: 302px;"></canvas>
                                    <div id="card-chart4-tooltip" class="c-chartjs-tooltip top bottom"
                                        style="opacity: 0; left: 214.188px; top: 149.6px;">
                                        <div class="c-tooltip-header">
                                            <div class="c-tooltip-header-item">November</div>
                                        </div>
                                        <div class="c-tooltip-body">
                                            <div class="c-tooltip-body-item"><span class="c-tooltip-body-item-color"
                                                    ...
                                                    class="c-tooltip-body-item-value">12</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="c-chart-wrapper" style="height:300px;margin-top:40px;">
                                ...
                                <canvas class="chart chartjs-render-monitor" id="main-chart" height="375" width="822"
                                    style="display: block; height: 300px; width: 658px;"></canvas>
                            </div>
                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="c-callout c-callout-danger"><small
                                                            class="text-muted">Recuring Clients</small>
                                    ...
                                    <table class="table table-responsive-sm table-hover table-outline mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="small text-muted">Last login</div><strong>10 sec
                                                        ago</strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="small text-muted">Last login</div><strong>5 minutes
                                                        ago</strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="small text-muted">Last login</div><strong>1 hour
                                                        ago</strong>
                                                </td>
                                            </tr>
                                            <tr>
